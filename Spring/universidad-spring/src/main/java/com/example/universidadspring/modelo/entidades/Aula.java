...
public class Aula implements Serializable {
    ...
    private Integer cantidaPupitres;
    ...
    public Aula(Integer id, Integer nroAula, String medidas, Integer cantidaPupitres, Pizarron pizarron) {
        this.id = id;
        this.nroAula = nroAula;
        this.medidas = medidas;
        this.cantidaPupitres = cantidaPupitres;
    ...
    public Integer getCantidaPupitres() {
        return cantidaPupitres;
    }

    public void setCantidaPupitres(Integer cantidaPupitres) {
        this.cantidaPupitres = cantidaPupitres;
    }
    ...
    public String toString() {
        return "Aula{" +
                ...
                ", nrpAula=" + nroAula +
                ", medidas='" + medidas + '\'' +
                ", cantidaPupitres=" + cantidaPupitres +
                ", pizarron=" + pizarron +
                ", fechaAlta=" + fechaAlta +
