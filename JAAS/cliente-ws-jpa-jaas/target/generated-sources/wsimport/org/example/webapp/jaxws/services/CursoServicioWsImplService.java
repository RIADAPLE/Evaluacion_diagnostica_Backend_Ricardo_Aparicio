 ...
 * 
 */
@WebServiceClient(name = "CursoServicioWsImplService", targetNamespace = "http://services.jaxws.webapp.example.org/", wsdlLocation = "http://localhost:8081/webapp-jaxws-jpa-jaas/CursoServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/webapp-jaxws-jpa-jaas/CursoServicioWsImpl?wsdl");
