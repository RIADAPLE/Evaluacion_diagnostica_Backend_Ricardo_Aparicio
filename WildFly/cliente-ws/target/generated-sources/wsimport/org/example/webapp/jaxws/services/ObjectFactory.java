 ...
 * generated in the org.example.webapp.jaxws.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _Crear_QNAME = new QName("http://services.jaxws.webapp.example.org/", "crear");
    private final static QName _CrearResponse_QNAME = new QName("http://services.jaxws.webapp.example.org/", "crearResponse");
    private final static QName _Listar_QNAME = new QName("http://services.jaxws.webapp.example.org/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://services.jaxws.webapp.example.org/", "listarResponse");
    private final static QName _Saludar_QNAME = new QName("http://services.jaxws.webapp.example.org/", "saludar");
    private final static QName _SaludarResponse_QNAME = new QName("http://services.jaxws.webapp.example.org/", "saludarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.example.webapp.jaxws.services
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.example.org/", name = "crear")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.example.org/", name = "crearResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.example.org/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.example.org/", name = "listarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.example.org/", name = "saludar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.example.org/", name = "saludarResponse")
